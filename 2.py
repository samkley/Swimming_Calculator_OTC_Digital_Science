...
wr_times = {"male50freestyle50": 20.91, "male50freestyle100": 46.86, "male50freestyle200": 102.00,
            "male50freestyle400": 220.07
    , "male50freestyle800": 452.12, "male50freestyle1500": 871.02, "male50backstroke50": 23.71, "male50backstroke100":
                51.60, "male50backstroke200": 111.92, "male50breaststroke50": 25.95, "male50breaststroke100": 56.88,
            "male50breaststroke200": 125.95, "male50butterfly50": 22.27, "male50butterfly100": 49.45,
            "male50butterfly200":
                110.34, "female50freestyle50": 23.67, "female50freestyle100": 51.71, "female50freestyle200": 112.98,
            ...
            "male25freestyle200":
                99.37, "male25freestyle400": 212.25, "male25freestyle800": 443.42, "male25freestyle1500": 846.88,
            "male25backstroke50": 22.22, "male25backstroke100": 48.33, "male25backstroke200": 105.63,
            "male25breaststroke50": 24.95, "male25breaststroke100": 55.28, "male25breaststroke200": 120.16,
            "male25butterfly50": 21.75, "male25butterfly100": 49.28, "male25butterfly200": 109.63,
            "female25freestyle50": 22.93, "female25freestyle100": 50.25, "female25freestyle200": 110.31,
            "female25freestyle400": 233.92, "female25freestyle800": 479.34, "female25freestyle1500": 918.01,
            "female25backstroke50": 25.27, "female25backstroke100": 54.89, "female25backstroke200": 118.94,
...
def main():
    if easygui.ccbox(msg="Welcome to the Swimming Calculator where time per lapse, number of lapses and time to a"
        ...
        if easygui.ccbox(msg="Do you want to proceed and calculate how much faster you have to swim to beat the current"
            ...
            try:
                ...
                personal_best_old = easygui.enterbox(msg="The current world record for the gender, stroke, distance"
                                                         ...
                                                         " you include it after the first SS which are the full seconds."
                                                         "For example: if you have a time of 1 hour, 20 minutes, and 5.04"
                                                         " seconds you would enter: 01:20:05:04".format(id, unit))
        ...
        if easygui.ccbox(msg="""Are you sure you want to exit the program, there is no way to undo this. 
                        ...
                        the program and s'Continue' to exit it""", title="Are you sure?"):
